...
app.post("/api/predict-future", async (req, res) => {
  try {
    ...
    const messages = [
      { role: "system", content: "You are a funny fortune teller. Create Funny, Futuristic, positive predictions in 3-4 sentences. Use the inputs naturally. Keep it light; no health, death, or lottery claims." },
...
Do NOT include extra text.` },
    ...
    // Only surface hint from API after 7th round
